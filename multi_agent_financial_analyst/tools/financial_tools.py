    ...
    def _run(self, symbol: str) -> str:
        try:
            ...
            response = {
                ...
                "52_week_high": {"price": info.get("fiftyTwoWeekHigh", "N/A"), "date": fifty_two_week_high_date},
                "52_week_low": {"price": info.get("fiftyTwoWeekLow", "N/A"), "date": fifty_two_week_low_date},
